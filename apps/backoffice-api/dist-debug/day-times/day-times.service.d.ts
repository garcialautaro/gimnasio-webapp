...
import { DayTime, DayTimeEntity, CreateDayTimeDto, UpdateDayTimeDto, GetAvailableDayTimesQuery, AvailableDayTimeSlot } from '@turnos/shared';
import { BookingsService } from '../bookings/bookings.service';
export declare class DayTimesService {
    private readonly dayTimeRepository;
    private readonly bookingsService;
    constructor(dayTimeRepository: Repository<DayTimeEntity>, bookingsService: BookingsService);
